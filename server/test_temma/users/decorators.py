...
from users.appvars import MANAGER, LAWYER, CUSTOMER, CLUB_Manager, NEW_MANAGER
...
# Fayyoz for creating club manager
def new_manager_required(
        function=None,
        redirect_field_name=REDIRECT_FIELD_NAME, login_url='/'):

    actual_decorator = user_passes_test(
        lambda u: u.is_active and u.user_type == NEW_MANAGER,
